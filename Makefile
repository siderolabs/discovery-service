...
.PHONY: sign-image-discovery-service
sign-image-discovery-service:  ## Signs the image for discovery-service. Requires interactive Google authentication.
	@test -n "$$GITHUB_TOKEN" || { \
	...
	@TMP=$$(mktemp -d) && trap 'rm -rf "$$TMP"' EXIT && \
	  ...
	  docker run --rm -p 127.0.0.1:8585:8585 \
	    ...
	    $(REGISTRY)/$(USERNAME)/discovery-service:$(IMAGE_TAG)
