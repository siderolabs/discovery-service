...
var file_v1alpha1_server_pb_cluster_proto_rawDesc = []byte{
	...
	0x6c, 0x6f, 0x73, 0x2d, 0x73, 0x79, 0x73, 0x74, 0x65, 0x6d, 0x73, 0x2f, 0x61, 0x70, 0x69, 0x2f,
	0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x31, 0x2f, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2f,
...
var (
	file_v1alpha1_server_pb_cluster_proto_msgTypes = make([]protoimpl.MessageInfo, 12)
	file_v1alpha1_server_pb_cluster_proto_goTypes  = []interface{}{
...
func file_v1alpha1_server_pb_cluster_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_v1alpha1_server_pb_cluster_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_v1alpha1_server_pb_cluster_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_v1alpha1_server_pb_cluster_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_v1alpha1_server_pb_cluster_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_v1alpha1_server_pb_cluster_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_v1alpha1_server_pb_cluster_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_v1alpha1_server_pb_cluster_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		file_v1alpha1_server_pb_cluster_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
		...
		file_v1alpha1_server_pb_cluster_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
		...
		file_v1alpha1_server_pb_cluster_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
		...
		file_v1alpha1_server_pb_cluster_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
		...
		file_v1alpha1_server_pb_cluster_proto_msgTypes[11].Exporter = func(v interface{}, i int) interface{} {
	...
	file_v1alpha1_server_pb_cluster_proto_msgTypes[3].OneofWrappers = []interface{}{}
	file_v1alpha1_server_pb_cluster_proto_msgTypes[4].OneofWrappers = []interface{}{}
	type x struct{}
